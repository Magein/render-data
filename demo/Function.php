...
function getData($number = 1)
{
    ...
    for ($i = 0; $i < $number; $i++) {
        $data[] = [
            ...
            'weight' => rand(45, 80),
            'height' => rand(160, 185),
            'favorite' => [rand(0, 3), rand(0, 3)],
            'photo' => 'http://pic.wxhand.com/wei_image/d8971cd90571645c008375f8866d2e42.png',
            'intro' => 'this is intro',
        ];
    }
...
function getName()
{
    ...
    $ming = '哲、启、善、唯、达、耀、兴、荣、华、旺、盈、丰、余、昌、盛、俊、威、英、健、壮、焕、挺、帅、秀、伟、武、雄、巍、松、柏、山、石、婵、娟、姣、妯、婷、姿、媚、婉、丽、妩、美、倩、兰、颖、灵、睿、锐、哲、慧、敦、迪、明、晓、显、悉、晰、维、学、思、悟、析、文、书、勤仁、义、礼、智、信、德、诚、伦、孝、忠、良、勤、俭、廉、文、章、斌';
...
{
    $title = include_once './FieldTitle.php';
